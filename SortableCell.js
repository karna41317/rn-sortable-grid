...
import { cellScale, cellAnimationTypes, cellTranslation } from "./constants"
...
export default class SortableCell extends Component {
	...
	startScaleAnimation = ({ scaleValue, callback }) => {
		...
		//    return
		//}
		this._scaleAnimationInstace = Animated.timing(this.state.scale, {
			toValue: scaleValue,
	...
	getTranslationAnimation = ({ animationType, coordinate }) => {
		...
		return Animated.timing(this.state.coordinate, {
			toValue: {
				x,
				y
			},
	...
	startTranslationAnimation = ({ animationType, coordinate, callback }) => {
		...
		//}
		this._translationAnimationInstace = this.getTranslationAnimation({
			animationType,
			coordinate
		})
	...
	stopTranslationAnimation = () => {
		...
		//    return
		//}
		this._translationAnimationInstace &&
			this._translationAnimationInstace.stop()
		this._translationAnimationInstace = null
	}
